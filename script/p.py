...
perceptron = ('perceptron', Perceptron(random_state=42,
              n_iter_no_change=20, max_iter=100, tol=1e-6, early_stopping=True))
...
plot_learning_curve(pipe, 'Tuning MinMaxScaler Smote Perceptron', X=X_train, y=y_train)
plt.savefig("perceptron_minmax_smote_tuning.png")
